...
function WoWPrimeAdminPanel:CreateStartFrames()
  local transparency = {
  ...
  ma_bgframe:SetFrameStrata(WoWPrimeAdminPanel.db.profile.style.framestrata)
  ...
  FrameLib:BuildFrame({ --Top Window Frame that has WoWPrimeAdminPanel Logo
    name = "ma_topframe",
    group = "bg",
    parent = ma_bgframe,
    texture = {
