...
local L = LibStub("AceLocale-3.0"):NewLocale("WoWPrimeAdminPanel", "enUS", true)
if L then
  local translations = {
--[[General]]
  --[[Tooltips]]
    ["tt_Default"]                    = "Move your cursor over an element to toggle the tooltip!",
    ["tt_LanguageButton"]             = "Reload UI",
...
--[[GM tab]]
  --[[Name]]
    ["tabmenu_Main"]                  = "GM",
  --[[Tooltips]]
    ["tt_MainButton"]                 = "Toggle tab with Game Master related functions",
    ...
    ["tt_SpectatorOnButton"]          = "Requires .gm on, allows the GM character to use /follow on members of opposite faction. Note: You may need to teleport to another zone / load a new area, it doesn't update on the fly",
    ["tt_SpectatorOffButton"]         = "Deactivate Spectator mode",
    ...
    ["tt_CheckBagButton"]             = "Check players bag",
    ["tt_CheckProfessionButton"]      = "Show known professions list for selected player",
  ...
  --["tt_chatoffbutton"]              = "Turn GM Chat OFF",
    ["tt_waterwalkonbutton"]          = "Turn Waterwalk ON for the selected player",
    ["tt_watewrwalkoffbutton"]        = "Turn Waterwalk OFF for the selected player",
    ["tt_cheatcasttimeonbutton"]      = "Enables or disables your character's spell cast times",
    ["tt_cheatcasttimeoffbutton"]     = "Enables or disables your character's spell cast times",
    ["tt_cheatcooldownonbutton"]      = "Enables or disables your character's spell cooldowns",
    ["tt_cheatcooldownoffbutton"]     = "Enables or disables your character's spell cooldowns",
    ["tt_cheatgodonbutton"]           = "Enables or disables your character's ability to take damage",
    ["tt_cheatgodoffbutton"]          = "Enables or disables your character's ability to take damage",
    ["tt_cheatpoweronbutton"]         = "Enables or disables your character's spell cost (e.g mana)",
    ["tt_cheatpoweroffbutton"]        = "Enables or disables your character's spell cost (e.g mana)",
    ["tt_cheatstatusbutton"]          = "Shows the cheats you currently have enabled",
  ...
  --[[Control Labels]]
    ...
    ["ma_SpectatorOnButton"]          = "Spectator mode On",
    ...
    ["ma_BankButton"]                 = "Bank",
    ["ma_CheckBagButton"]             = "Check Bags",
    ["ma_CheckProfessionButton"]      = "Chk Profess",
    ...
    ["ma_cheatcasttimebutton"]        = "CastTime On",
    ["ma_cheatcooldownbutton"]        = "Cooldown On",
    ["ma_cheatgodbutton"]             = "God Mode On",
    ["ma_cheatpowerbutton"]           = "Power On",
    ["ma_cheatstatusbutton"]          = "Cheat Status",
...
--[[Char Tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_charmorphbutton"]            = "Applies morph on the selected character - Parameters = #DisplayID [[Enter the DisplayID of the morph you want to apply]]",
    ["tt_DemorphButton"]              = "Removes any morphs on the selected player",
    ...
    ["tt_modelzoominbutton"]          = "Zoom in the selected player",
    ["tt_modelzoomoutbutton"]         = "Zoom out the selected player",
    ["tt_charbindsight"]              = "Binds your vision to the selected player",
    ["tt_charunbindsight"]            = "UnBinds your vision from the selected player",
    ...
    ["tt_charfreeze"]                 = "Freezes selected player and disables their chat",
    ...
    ["tt_charpossess"]                = "Indefinitely possesses the selected player",
    ["tt_charunpossess"]              = "Unpossesses the selected player",
...
--[[NPC Tab]]
  --[[Name]]
    ["tabmenu_NPC"]                   = "NPC",
    ["tt_NpcButton"]                  = "Toggle tab with NPC related functions",
  --[[Tooltips]]
    ["tt_NPCRotateLeft"]              = "Rotate left",
    ["tt_NPCRotateRight"]             = "Rotate right",
    ["tt_NPCKillButton"]              = "Kills the selected target",
    ["tt_npcrespawn"]                 = "Respawns selected NPC, or if none selected, all nearby NPC",
    ["tt_NPCDistanceButton"]          = "Get distance to the selected NPC",
    ...
    ["tt_NPCMove"]                    = "Move the selected NPC to your location",
    ["tt_NPCDel"]                     = "Deletes the selected NPC",
    ...
    ["tt_npcmodelzoominbutton"]       = "Zoom in the selected NPC",
    ["tt_npcmodelzoomoutbutton"]      = "Zoom out the selected NPC",
    ...
    ["tt_npcpossess"]                 = "Indefinitely possesses the selected NPC",
    ["tt_npcunpossess"]               = "Unpossesses the selected NPC",
    ...
    ["tt_WayModifyDel"]               = "Deletes the selected waypoint from NPC existing move stack",
    ["tt_WayShow0"]                   = "Stops showing waypoints for selected NPC",
    ["tt_WayShow1"]                   = "Show waypoints for selected NPC",
    ["tt_NPCAdd_WayShowOn"]           = "Show waypoints for the selected NPC",
    ...
    ["tt_MoveStackButton"]            = "Show movement stack of the selected NPC",
  --[[Control Labels]]
    ["Morph"]                         = "Morph",
...
--[[GObjects Tab]]
  --[[Name]]
    ["tabmenu_GO"]                    = "GOB",
    ["tt_GOButton"]                   = "Toggle tab with GObject related functions",
  --[[Tooltips]]
    ...
    ["tt_ObjClearInfo"]               = "Clears the GUID, EntryID, Range, DisplayID and Phase fields",
    ["tt_ObjSetPhase"]                = "Sets the phase of the object",
    ["tt_ObjRotateLeft"]              = "Rotate left",
    ["tt_ObjRotateRight"]             = "Rotate right",
    ["tt_ObjModelzoominbutton"]       = "Zoom in the selected Object Model",
    ["tt_ObjModelzoomoutbutton"]      = "Zoom out the selected Object Model",
...
--[[Tele Tab]]
  --[[Name]]
    ["tabmenu_Tele"]                  = "TELE",
    ["tt_TeleButton"]                 = "Toggle tab with Teleport related functions",
  --[[Tooltips]]
  --[[Control Labels]]
...
--[[Tickets Tab]]
  --[[Name]]
    ...
    ["tt_TicketButton"]               = "Toggle tab with GM ticket related functions",
  --[[Tooltips]]
...
--[[Misc Tab]]
  ...
  --[[Other]]
    ...
    ["ma_WeatherSnow"]                = "Snow",
    ["ma_WeatherSand"]                = "Sand",
    ["msg_transparency_saved"]        = "|cff00ff00WoWPrimeAdminPanel:|r Transparency setting saved. Update Changes or Reload UI to apply",
    ["msg_localsearch_saved"]         = "|cff00ff00WoWPrimeAdminPanel:|r Localized search strings setting saved. Update Changes or Reload UI to apply",
    ["msg_minimenu_saved"]            = "|cff00ff00WoWPrimeAdminPanel:|r Minimenu setting saved",
    ["msg_tooltip_saved"]             = "|cff00ff00WoWPrimeAdminPanel:|r Tooltip setting saved. Update Changes or Reload UI to apply",
    ["msg_chatoutput_saved"]          = "|cff00ff00WoWPrimeAdminPanel:|r Chat output setting saved",
...
--[[Pop UPs]]
  ...
  --[[ToolTips]]
    ...
    ["tt_TeleSearchButton"]           = "Toggle a popup with the function to search for telepors and manage your favorites",
    ["tt_SendMail"]                   = "Toggle a popup with the function to send mail",
    ["tt_SearchDefault"]              = "Now you can enter a keyword and start the search",
  --[[Labels]]
    ["ma_PopupErrorTab"]              = "ERROR",
    ["ma_PopupFavoritesTab"]          = "Favorites",
    ["ma_PopupTab3"]                  = "Tab 3",
    ["ma_PopupRecentTab"]             = "Recent",
    ...
    ["ma_ClearRecentButton"]          = "Clear Recent",
    ...
    ["recentResults"]                 = "|cFFFFAA00Recent:|r ",
    ["ma_NoRecent"]                   = "No recently used entries for this type.",
    ["ma_CtxAddFav"]                  = "Add to Favorites",
    ["ma_CtxRemoveFav"]               = "Remove from Favorites",
    ["ma_CtxCopyId"]                  = "Copy ID",
    ["ma_CtxCopyName"]                = "Copy Name",
    ["ma_ItemConfirmSelf"]            = "Add %s to your inventory?",
    ["ma_ItemConfirmTarget"]          = "Add %s to %s's inventory?",
    ["ma_FilterLabel"]                = "Filter:",
    ["ma_SortDefault"]                = "Sort: Default",
    ["ma_SortNameAZ"]                 = "Sort: A\226\134\146Z",
    ["ma_SortNameZA"]                 = "Sort: Z\226\134\144A",
    ["ma_SortIdAsc"]                  = "Sort: ID \226\134\145",
