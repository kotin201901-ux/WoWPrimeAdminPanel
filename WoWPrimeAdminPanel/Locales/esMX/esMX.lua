...
local L = LibStub("AceLocale-3.0"):NewLocale("WoWPrimeAdminPanel", "esMX")
if L then
  local translations = {
--[[General]]
  --[[Tooltips]]
  ...
  --[[Control Labels]]
    ["ma_LanguageButton"]             = "Recargar UI",
    ["ma_RefreshButton"]              = "Actualizar",
    ...
    ["ma_InfoRevisionText"]           = "Revisión TrinityCore: ...",
    ["info_revision"]                 = "|cFF00FF00Revisión TrinityCore:|r ",
...
--[[GM tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_ScreenButton"]               = "Tomar una captura de pantalla.",
    ...
    ["tt_SpeedSliderReset"]           = "Resetear Velocidad a 1.0",
    ["tt_ScaleSliderReset"]           = "Resetear Escala a 1.0",
...
--[[Char Tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_resetbutton"]                = "Resetear el atributo seleccionado",
    ...
    ["tt_createguildbutton"]          = "Parámetros= $GuildLeaderName $GuildName  [[Crea un gremio llamado $GuildName, con $GuildLeaderName como líder]]",
    ...
    ["tt_guildinvitebutton"]          = "Parámetros= $charactername $guildname   [[Añade $charactername al gremio $guildname]]",
    ...
    ["tt_guildrankbutton"]            = "Parámetros= $charactername #ranknumber   [[Establece al personaje especificado al rango especificado en su gremio]]",
    ...
    ["tt_guilddeletebutton"]          = "Parámetro= $guildname  [[Elimina el Gremio especificado]]",
    ["tt_guilduninvitebutton"]        = "Parámetro= $charactername  [[Expulsa al personaje especificado de su gremio]]",
  ...
  --[[Control Labels]]
    ...
    ["ma_guilddeletebutton"]          = "Eliminar G",
    ["ma_guilduninvitebutton"]        = "Expulsar G",
  ...
  --[[Other]]
    ...
    ["ma_AllRecipesLeatherworking"]   = "Todas las Recetas (Curtiduría)",
...
--[[Misc Tab]]
  ...
  --[[Other]]
    ...
    ["ma_WeatherFine"]                = "Despej",
    ["ma_WeatherFog"]                 = "Niebla",
    ["ma_WeatherRain"]                = "Lluvia",
    ["ma_WeatherSnow"]                = "Nieve",
    ["ma_WeatherSand"]                = "Arena",
    ["msg_transparency_saved"]        = "|cff00ff00WoWPrimeAdminPanel:|r Configuración de transparencia guardada. Actualiza Cambios o Recarga la UI para aplicar.",
    ["msg_localsearch_saved"]         = "|cff00ff00WoWPrimeAdminPanel:|r Configuración de cadenas de búsqueda localizadas guardada. Actualiza Cambios o Recarga la UI para aplicar.",
    ["msg_minimenu_saved"]            = "|cff00ff00WoWPrimeAdminPanel:|r Configuración de minimenú guardada.",
    ["msg_tooltip_saved"]             = "|cff00ff00WoWPrimeAdminPanel:|r Configuración de descripciones emergentes guardada. Actualiza Cambios o Recarga la UI para aplicar.",
