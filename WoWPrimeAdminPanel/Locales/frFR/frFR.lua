...
--[[General]]
  ...
  --[[Control Labels]]
    ...
    ["ma_InfoRevisionText"]           = "Révision TrinityCore : ...",
...
--[[GM tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_SpectatorOnButton"]           = "Nécessite .gm on, permet au personnage GM d'utiliser /follow sur les membres de la faction opposée. Note : Vous devrez peut-être vous téléporter dans une autre zone / charger une nouvelle zone, cela ne se met pas à jour en temps réel.",
    ["tt_SpectatorOffButton"]          = "Désactiver le mode Spectateur.",
  ...
  --[[Control Labels]]
    ...
    ["ma_SpectatorOnButton"]           = "Mode Spectateur activé",
...
--[[NPC Tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_NPCEntryIDButton"]           = "Affiche le GUID du personnage sélectionné.",
  ...
  --[[Control Labels]]
    ...
    ["ma_NPCEntryIDButton"]           = "Afficher GUID",
