...
selected language.
1. Edit the first un-commented line below, which should resemble: function Return_ptBR(). Change
...
local L = LibStub("AceLocale-3.0"):NewLocale("WoWPrimeAdminPanel", "ptBR")
if L then
  local translations = {
--[[General]]
  --[[Tooltips]]
    ["tt_Default"]                    = "Mova o cursor sobre um elemento para alternar a dica!",
    ["tt_LanguageButton"]             = "Recarregar WoWPrimeAdminPanel e aplicar idioma selecionado.",
  ...
  --[[Control Labels]]
    ...
    ["ma_InfoRevisionText"]           = "Revisão TrinityCore: ...",
    ["info_revision"]                 = "|cFF00FF00Revisão TrinityCore:|r ",
...
--[[GM tab]]
  --[[Name]]
    ["tabmenu_Main"]                  = "GM",
  --[[Tooltips]]
    ["tt_MainButton"]                 = "Alternar janela principal do WoWPrimeAdminPanel.",
    ...
    ["tt_SpectatorOnButton"]           = "Requer .gm on, permite que o personagem GM use /follow em membros da facção oposta. Nota: Pode ser necessário se teletransportar para outra zona / carregar uma nova área, não atualiza em tempo real.",
    ["tt_SpectatorOffButton"]          = "Desativar modo Espectador.",
    ...
    ["tt_ScreenButton"]               = "Fazer uma captura de tela.",
  ...
  --["tt_chatoffbutton"]              = "Turn GM Chat OFF",
    ...
    ["tt_SpeedSliderReset"]           = "Resetar Velocidade para 1.0",
    ["tt_ScaleSliderReset"]           = "Resetar Escala para 1.0",
  ...
  --[[Control Labels]]
    ...
    ["ma_SpectatorOnButton"]           = "Modo Espectador ativo",
...
--[[Char Tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_saveplayer"]                 = "Salva o personagem do jogador selecionado",
    ...
    ["tt_RecallButton"]               = "Retorna o jogador selecionado à localização antes do último teletransporte.",
    ...
    ["tt_resetbutton"]                = "Resetar o atributo selecionado",
    ...
    ["tt_charmaxskill"]               = "Define as habilidades do personagem selecionado para o valor máximo do nível",
    ...
    ["tt_charlistdeleted"]            = "Lista personagens excluídos na janela de chat",
    ...
    ["tt_guilddeletebutton"]          = "Parâmetro= $guildname  [[Exclui a Guilda especificada]]",
  ...
  --[[Control Labels]]
    ...
    ["ma_charmaxskill"]               = "Hab Máxima",
    ["ma_charfreeze"]                 = "Congelar",
    ["ma_charunfreeze"]               = "Descongelar",
    ["ma_charlistdeleted"]            = "ListarCharExcl",
    ["ma_chardeletedrestore"]         = "RestaurarCharExcl",
    ...
    ["ma_guilddeletebutton"]          = "G Excluir",
...
--[[NPC Tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_NPCEntryIDButton"]           = "Mostra o GUID do personagem selecionado.",
    ...
    ["tt_NPCDel"]                     = "Exclui a criatura selecionada",
    ...
    ["tt_npccometome"]                = "Força o NPC selecionado a vir para a sua localização. Localização NÃO salva na BD.",
    ["tt_npcpossess"]                 = "Possui indefinidamente a criatura selecionada",
    ["tt_npcunpossess"]               = "Deixa de possuir a criatura selecionada",
    ["tt_NPCFreezeButton"]            = "Para o movimento do NPC selecionado, salvando Waypoints",
    ["tt_NPCFreezeDelButton"]         = "Para o movimento do NPC selecionado, SEM salvar Waypoints",
    ...
    ["tt_WayModifyDel"]               = "Exclui o waypoint selecionado da pilha de movimento existente da criatura",
...
--[[GObjects Tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_ObjDel"]                     = "Exclui o objeto alvo",
...
--[[Misc Tab]]
  ...
  --[[Tooltips]]
    ["tt_FrmTrSlider"]                = "Alterar transparência do quadro",
    ["tt_BtnTrSlider"]                = "Alterar transparência dos botões",
    ["tt_windowismovable"]            = "Permitir uma janela movível",
    ["tt_updatechanges"]              = "Aplicar alterações feitas às configurações. Recarrega a UI.",
  ...
  --[[Control Labels]]
    ...
    ["ma_FrameStrataFullscreen"]      = "Tela Cheia",
    ["ma_FrameStrataFullscreenDialog"] = "Diálogo Tela Cheia",
    ["ma_UpdateFrequencyLabel"]       = "Frequência de atualização do gráfico Diff:",
    ["ma_BackgroundColorLabel"]       = "Cor de Fundo",
    ["ma_FrameColorLabel"]            = "Cor do Quadro",
  ...
  --[[Other]]
    ...
    ["msg_transparency_saved"]        = "|cff00ff00WoWPrimeAdminPanel:|r Configuração de transparência salva. Atualize Alterações ou Recarregue a UI para aplicar.",
    ["msg_localsearch_saved"]         = "|cff00ff00WoWPrimeAdminPanel:|r Configuração de strings de pesquisa localizadas salva. Atualize Alterações ou Recarregue a UI para aplicar.",
    ["msg_minimenu_saved"]            = "|cff00ff00WoWPrimeAdminPanel:|r Configuração de minimenú salva.",
    ["msg_tooltip_saved"]             = "|cff00ff00WoWPrimeAdminPanel:|r Configuração de dicas salva. Atualize Alterações ou Recarregue a UI para aplicar.",
    ["msg_chatoutput_saved"]          = "|cff00ff00WoWPrimeAdminPanel:|r Configuração de saída do chat salva.",
...
--[[Pop UPs]]
  ...
  --[[ToolTips]]
    ...
    ["tt_SkillButton"]                = "Alternar uma janela com a função de procurar habilidades e gerir os seus favoritos.",
  --[[Labels]]
    ...
    ["ma_SkillButton"]                = "Pesquisar-Habilidade",
    ["ma_SkillVar1Button"]            = "Habilidade",
    ["ma_SkillVar2Button"]            = "Habilidade Máxima",
    ["ma_ItemVar1Button"]             = "Quantidade",
    ["ma_ObjectVar1Button"]           = "Modelo de Saque",
    ["ma_ObjectVar2Button"]           = "Tempo de Aparecimento",
    ["ma_NoFavorites"]                = "Não existem favoritos salvos atualmente!",
