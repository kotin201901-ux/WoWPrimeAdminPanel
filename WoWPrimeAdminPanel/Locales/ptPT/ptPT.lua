...
local L = LibStub("AceLocale-3.0"):NewLocale("WoWPrimeAdminPanel", "ptPT")
if L then
  local translations = {
--[[General]]
  --[[Tooltips]]
...
--[[GM tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_SpectatorOnButton"]           = "Requer .gm on, permite que o personagem GM use /follow em membros da facção oposta. Nota: Pode ser necessário teletransportar-se para outra zona / carregar uma nova área, não atualiza em tempo real.",
...
--[[Misc Tab]]
  ...
  --[[Other]]
    ...
    ["msg_transparency_saved"]        = "|cff00ff00WoWPrimeAdminPanel:|r Definição de transparência guardada. Atualize Alterações ou Recarregue a UI para aplicar.",
    ["msg_localsearch_saved"]         = "|cff00ff00WoWPrimeAdminPanel:|r Definição de strings de pesquisa localizadas guardada. Atualize Alterações ou Recarregue a UI para aplicar.",
    ["msg_minimenu_saved"]            = "|cff00ff00WoWPrimeAdminPanel:|r Definição de minimenú guardada.",
    ["msg_tooltip_saved"]             = "|cff00ff00WoWPrimeAdminPanel:|r Definição de dicas guardada. Atualize Alterações ou Recarregue a UI para aplicar.",
    ["msg_chatoutput_saved"]          = "|cff00ff00WoWPrimeAdminPanel:|r Definição de saída do chat guardada.",
