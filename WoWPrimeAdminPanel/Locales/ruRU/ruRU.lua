...
--[[GM tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_SpectatorOnButton"]           = "Требуется .gm on, позволяет персонажу GM использовать /follow на членах противоположной фракции. Примечание: Возможно, потребуется телепортироваться в другую зону / загрузить новую область, изменения не применяются мгновенно.",
    ["tt_SpectatorOffButton"]          = "Деактивировать режим Наблюдателя.",
...
--[[NPC Tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_NPCEntryIDButton"]           = "Показать GUID выбранного персонажа.",
