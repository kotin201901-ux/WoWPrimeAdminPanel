...
--[[GM tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_SpectatorOnButton"]           = "需要.gm on，允许GM角色对对立阵营成员使用/follow。注意：你可能需要传送到另一个区域/加载新区域，此功能不会即时更新。",
    ["tt_SpectatorOffButton"]          = "关闭旁观者模式。",
...
--[[Char Tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_RecallButton"]               = "将所选玩家召回到上次传送前的位置。",
...
--[[NPC Tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_NPCEntryIDButton"]           = "显示所选角色的GUID。",
